...
if __name__ == "__main__":
    ...
    model_dir = os.path.join(work_dir, "task_1_ccre/supervised_models/probed/{model_name}")
    ...
    out_dir = os.path.join(work_dir, "task_1_ccre/supervised_model_outputs/probed/{model_name}")
