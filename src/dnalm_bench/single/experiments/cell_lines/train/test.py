...
if __name__ == "__main__":
    ...
    out_dir = f"/scratch/groups/akundaje/dnalm_benchmark/predictors/cell_line_2114/test/v1"    
    os.makedirs(out_dir, exist_ok=True)

    peaks_train_datset = AssayEmbeddingsDataset(peaks_h5, peaks_tsv, chroms_train, assay_bw, crop=crop)
    nonpeaks_train_dataset = AssayEmbeddingsDataset(nonpeaks_h5, nonpeaks_tsv, chroms_train, assay_bw, crop=crop)
