...
from ....finetune import ChromatinEndToEndDataset, train_finetuned_chromatin_model, HyenaDNALoRAModel
...
if __name__ == "__main__":
    ...
    out_dir = f"/home/atwang/dnalm_bench_data/predictors/cell_line_2114_ft/{model_name}/{cell_line}/v3"    
