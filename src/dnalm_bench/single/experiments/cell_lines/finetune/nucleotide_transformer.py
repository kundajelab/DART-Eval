...
from ....finetune import ChromatinPredictionHead, ChromatinEndToEndDataset, train_finetuned_chromatin_model, MistralDNALoRAModel
...
if __name__ == "__main__":
    ...
    model = MistralDNALoRAModel(model_name, lora_rank, lora_alpha, lora_dropout)
