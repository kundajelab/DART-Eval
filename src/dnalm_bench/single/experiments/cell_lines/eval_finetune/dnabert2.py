...
from ....finetune import ChromatinEndToEndDataset, evaluate_finetuned_chromatin_model, DNABERT2LoRAModel
...
if __name__ == "__main__":
    ...
    model_dir = f"/home/atwang/dnalm_bench_data/predictors/cell_line_2114_ft/{model_name}/{cell_line}/v7"
    checkpoint_nums = {
        "GM12878": 9,
        "H1ESC": 5,
        "HEPG2": 12,
