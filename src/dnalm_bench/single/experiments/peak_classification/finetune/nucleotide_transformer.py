...
from ....finetune import PeaksEndToEndDataset, train_finetuned_peak_classifier, NucleotideTransformerLoRAModel
...
if __name__ == "__main__":
    ...
    model = NucleotideTransformerLoRAModel(model_name, lora_rank, lora_alpha, lora_dropout, len(classes))
