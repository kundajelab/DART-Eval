...
if __name__ == "__main__":
    ...
    # h5_file = "dnabert2.Afr.ASB.CaQTLS.variant_embeddings.h5"
    h5_file = "dnabert2.gm12878.dsqtls.benchmarking.variant_embeddings.h5"
    ...
    # df.write_csv(os.path.join(out_dir, "dnabert2.Afr.ASB.CaQTLS.cosine_distances.tsv"), separator="\t")
    df.write_csv(os.path.join(out_dir, "dnabert2.gm12878.dsqtls.benchmarking.cosine_distances.tsv"), separator="\t")
