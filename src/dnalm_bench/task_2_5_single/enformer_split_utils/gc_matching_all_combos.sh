...
filedir=/oak/stanford/groups/akundaje/projects/dnalm_benchmark/enformer_splits_files/GM12878/
...
bash run_chrombpnet_training.sh $filedir/file_lists/task_list.txt $filedir/file_lists/genome_files.txt $filedir/file_lists/bigwig_files.txt $filedir/file_lists/peak_files.txt $filedir/file_lists/nonpeak_files.txt $filedir 3 $biasmodel /oak/stanford/groups/akundaje/projects/dnalm_benchmark/enformer_splits_files/GM12878/chrombpnet_model/ DNASE_PE 