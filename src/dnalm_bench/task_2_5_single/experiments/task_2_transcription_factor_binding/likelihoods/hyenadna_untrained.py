...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(root_output_dir,"task_2_footprinting/outputs/likelihoods/untrained/")
    os.makedirs(out_dir, exist_ok=True)
    out_path = os.path.join(root_output_dir,f"task_2_footprinting/outputs/likelihoods/untrained/{model_name}.tsv")
