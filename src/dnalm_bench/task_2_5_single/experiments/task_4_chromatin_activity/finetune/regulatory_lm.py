...
from ....finetune import ChromatinEndToEndDataset, train_finetuned_chromatin_model, RegulatoryLMLoRAModel
...
if __name__ == "__main__":
    ...
    lora_model = RegulatoryLMLoRAModel(model, lora_rank, lora_alpha, lora_dropout, 1, emb_channels, seq_input_size=2114)
    train_finetuned_chromatin_model(train_pos_dataset, train_neg_dataset, val_pos_dataset, val_neg_dataset, lora_model, 
