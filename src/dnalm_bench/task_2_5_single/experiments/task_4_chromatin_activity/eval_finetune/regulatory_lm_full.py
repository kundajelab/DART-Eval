...
from ....finetune import ChromatinEndToEndDataset, evaluate_finetuned_chromatin_model, RegulatoryLMLoRAModel, RegulatoryLMFullFinetuneFullContext
...
if __name__ == "__main__":
    ...
    metrics = evaluate_finetuned_chromatin_model(pos_dataset, idr_dataset, neg_dataset, finetune_model, batch_size, out_path,
