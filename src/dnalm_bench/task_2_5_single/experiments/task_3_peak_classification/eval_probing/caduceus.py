...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(root_output_dir,f"task_3_peak_classification/supervised_model_outputs/probed/{model_name}")
    os.makedirs(out_dir, exist_ok=True)
    out_path = os.path.join(out_dir, f"eval_{eval_mode}.json")

    model_dir = os.path.join(root_output_dir, f"task_3_peak_classification/supervised_models/probed/{model_name}")
