...
from ....finetune import PeaksEndToEndDataset, train_finetuned_peak_classifier, MistralDNALoRAModel
...
if __name__ == "__main__":
    ...
    model = MistralDNALoRAModel(model_name, lora_rank, lora_alpha, lora_dropout, len(classes))
