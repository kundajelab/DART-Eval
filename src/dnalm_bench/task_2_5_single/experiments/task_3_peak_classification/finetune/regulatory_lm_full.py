...
from ....finetune import PeaksEndToEndDataset, train_finetuned_peak_classifier, RegulatoryLMFullFinetune
...
if __name__ == "__main__":
    ...
    lora_model = RegulatoryLMFullFinetune(model, len(classes), emb_channels, seq_input_size=500, dropout=0.2)

    train_finetuned_peak_classifier(train_dataset, val_dataset, lora_model, 
