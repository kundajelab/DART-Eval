...
merged_df_output_path = os.path.join(dart_work_dir, "task_3_peak_classification/input_data/merged_counts_matrix.csv")
...
for i in range(0, len(sample_names), 3):
    ...
    output_path = os.path.join(dart_work_dir, "task_3_peak_classification/input_data/", f"{cell_type}/{cell_type}_deseq_input_coldata.csv")
